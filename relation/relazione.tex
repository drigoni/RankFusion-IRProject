...
Precision has been calculated by considering ten and thirty cut-off levels, it is very important to mark runs that have relevant documents in high positions. If we consider cut-off level equal to the recall base (the number of the relevant documents in the pool for a certain topic), we can use another interesting measure that is R-Prec.
