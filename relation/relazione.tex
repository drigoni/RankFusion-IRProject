...
\begin{wrapfigure}
\centering
\includegraphics[scale=0.34]{2comparison}
%\caption{AP for three IR models and Standard Rank Fusion strategies}
\end{wrapfigure}
...
\begin{wrapfigure}
\centering
\includegraphics[scale=0.31]{1comparison}
%\caption{AP for Standard Rank Fusion strategies and ProbFuse}
\end{wrapfigure}
